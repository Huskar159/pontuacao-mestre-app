-- Inserir exercícios para a categoria 'virgula-avancado'

-- Primeiro, verificar se a categoria já existe
INSERT INTO exercise_categories (id, title, description)
SELECT 'virgula-avancado', 'Vírgula Avançado', 'Exercícios avançados sobre o uso da vírgula em contextos mais complexos da língua portuguesa.'
WHERE NOT EXISTS (SELECT 1 FROM exercise_categories WHERE id = 'virgula-avancado');
...
-- Opções para o Exercício 1 (substituir :exercise_id pelo ID retornado)
