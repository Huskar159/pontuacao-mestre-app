  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        option_text: 'A Declaração Universal dos Direitos Humanos - 1948 - é um documento marco na história dos direitos humanos.',
        is_correct: false,
        explanation: 'Incorreto! Embora o travessão esteja sendo usado corretamente, a questão pede especificamente o uso de parênteses.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        option_text: 'O filme)dirigido por Steven Spielberg(ganhou vários prêmios internacionais.',
        is_correct: false,
        explanation: 'Incorreto! Os parênteses estão invertidos e não há espaços adequados.'
      },
      {
        id: 70030,
        exercise_id: 7006,
        ...
        is_correct: false,
        explanation: 'Incorreto! Embora o travessÃ£o esteja sendo usado corretamente, a questÃ£o pede especificamente o uso de parÃªnteses.'
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        option_text: 'Segundo Silva - 2020 - a educação é um processo contínuo de aprendizagem.',
        is_correct: false,
        explanation: 'Incorreto! Embora o travessão esteja sendo usado para isolar o ano, a questão pede especificamente o uso de parênteses.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        option_text: 'O novo smartphone custando (R$ 3.500,00) será lançado no próximo mês.',
        is_correct: false,
        explanation: 'Incorreto! Os parênteses deveriam incluir o gerúndio "custando" junto com o valor.'
      },
      {
        id: 70183,
        exercise_id: 7037,
...
export const parentesesExercicio5: Exercise[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        option_text: 'Favor enviar o(s documento(s) solicitado(s) para o departamento financeiro.',
        is_correct: false,
        explanation: 'Incorreto! O primeiro parêntese está mal posicionado, deveria incluir apenas o "s".'
      },
      {
        id: 70203,
        exercise_id: 7041,
        option_text: 'Favor enviar (o)s documento(s) solicitado(s) para o departamento financeiro.',
        is_correct: false,
        explanation: 'Incorreto! O primeiro parêntese está isolando incorretamente o artigo em vez de apenas o "s".'
      },
      {
        id: 70204,
        exercise_id: 7041,
  ...
  },
  {
    id: 7049,
    category_id: 'parenteses-5',
    question: 'Em qual alternativa os parênteses estão sendo usados corretamente para indicar uma pronúncia?',
    ...
    options: [
      {
        id: 70241,
        exercise_id: 7049,
        option_text: 'O termo francês "rendez-vous" (rã-de-vu) significa "encontro" em português.',
        is_correct: true,
        explanation: 'Correto! Os parênteses estão sendo usados adequadamente para indicar a pronúncia aproximada da palavra estrangeira.'
      },
      {
        id: 70242,
        exercise_id: 7049,
    ...
    options: [
      {
        id: 70246,
        exercise_id: 7050,
        option_text: 'A soma de 5 mais 3 é igual a 8 (5 + 3 = 8).',
        is_correct: true,
        explanation: 'Correto! Os parênteses estão sendo usados adequadamente para indicar o resultado da operação matemática.'
      },
      {
        id: 70247,
        exercise_id: 7050,
...
// Combinar todas as questões da prova final (5 originais + 25 adicionais)
// Criar arrays vazios para as questões adicionais
const additionalProvaParenteses: Exercise[] = [];
const additionalProvaParenteses2: Exercise[] = [];
const additionalProvaParenteses3: Exercise[] = [];

const todasQuestoesProvaParenteses: Exercise[] = [
  ...provaParenteses,                // 5 questões originais
  ...additionalProvaParenteses,      // 10 questões adicionais (parte 1)
  ...additionalProvaParenteses2,     // 10 questões adicionais (parte 2)
  ...additionalProvaParenteses3      // 5 questões adicionais (parte 3)
];

// Garantir que temos o número correto de questões
console.log(`[parentesesData] Questões originais: ${provaParenteses.length}`);
...
export async function getParentesesExercises(categoryId: string): Promise<Exercise[]> {
  ...
  console.log(`[getParentesesExercises] Carregando exercícios para categoria: ${categoryId}`);
  let result: Exercise[] = [];
  ...
  switch(categoryId) {
    ...
    case 'prova-parenteses':
      // Retornar os exercícios da prova final (array combinado com 30 questões)
      result = todasQuestoesProvaParenteses;
      console.log(`[getParentesesExercises] Prova final de parênteses com ${result.length} questões`);
      // Verificar se as questões têm a categoria correta
      const corretas = result.filter(q => q.category_id === 'prova-parenteses').length;
      console.log(`[getParentesesExercises] Questões com category_id correto: ${corretas}`);
      break;
    default:
      result = [];
  }
  
  console.log(`[getParentesesExercises] Retornando ${result.length} exercícios`);
  return result;
}
