  ...
  return (
    <StudyLayout>
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
        {/* Welcome Banner */}
        <div className="w-full bg-gradient-to-r from-brand-blue to-blue-600 text-white rounded-xl shadow-lg mb-8">
          <div className="p-6">
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Guia de Pontuação</h2>
            <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">Clique em uma pontuação para ver como usá-la corretamente</p>
          </div>
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Domínio da Vírgula</h2>
            <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">Siga o caminho para se tornar um mestre no uso da vírgula</p>
          </div>
          
          {/* Módulo Explicativo */}
          <Card className="mb-4 md:mb-6 border-l-4 border-brand-blue">
            <CardContent className="p-3 md:p-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" size="sm" className="mt-2 sm:mt-0 text-brand-blue border-brand-blue hover:bg-brand-lightBlue">
                      Ver Explicação
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="sm:max-w-[600px]">
                    ...
                    <div className="md:flex items-center justify-between">
                      <div className="flex items-center mb-4 md:mb-0">
                        ...
                        <div>
                          ...
                          <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">{module.description}</p>
                        </div>
                      </div>
                      
                      <div className="mt-4 md:mt-0">
                        {module.unlocked ? (
                          <Link to={module.path} state={{ from: 'pontuacao' }}>
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Domínio do Ponto e Vírgula</h2>
            <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">Siga o caminho para se tornar um mestre no uso do ponto e vírgula</p>
          </div>
              ...
              {pontoVirgulaModuleData.map((module, index) => (
                <Card key={`pv-${module.id}`} className={`transition-all ${module.unlocked ? 'opacity-100' : 'opacity-70'}`}>
                  <CardContent className="p-6">
                    <div className="md:flex items-center justify-between">
                      <div className="flex items-center mb-4 md:mb-0">
                        <div className={`${module.color} text-white rounded-full p-2 md:p-3 mr-3 md:mr-4 shadow-md`}>
                          {module.icon}
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Domínio dos Dois Pontos</h2>
            <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">Siga o caminho para se tornar um mestre no uso dos dois pontos</p>
          </div>
          
          {/* Módulo Explicativo */}
          <Card className="mb-4 md:mb-6 border-l-4 border-indigo-500">
            <CardContent className="p-3 md:p-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div className="flex items-center mb-2 sm:mb-0">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" size="sm" className="mt-2 sm:mt-0 text-indigo-500 border-indigo-500 hover:bg-indigo-100">
                      Ver Explicação
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="w-full mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold">Domínio dos Parênteses</h2>
            <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-0">Siga o caminho para se tornar um mestre no uso dos parênteses</p>
          </div>
          
          {/* Módulo Explicativo */}
          <Card className="mb-4 md:mb-6 border-l-4 border-purple-500">
            <CardContent className="p-3 md:p-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div className="flex items-center mb-2 sm:mb-0">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" size="sm" className="mt-2 sm:mt-0 text-purple-500 border-purple-500 hover:bg-purple-100">
                      Ver Explicação
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="sm:max-w-[600px]">
        ...
        {/* Área removida conforme solicitação - 28/05/2025 */}
