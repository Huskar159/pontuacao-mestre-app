          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <PlanCard 
              ...
              features={[
                ...
                { text: "250 exercícios de interpretação textual (artigos de opinião, textos jurídicos, editoriais de jornal, textos dissertativos, cartas, textos literários e científicos)", included: false },
            ...
            <PlanCard 
              ...
              features={[
                ...
                { text: "Gabaritos comentados com justificativas", included: true },
                { text: "Acesso permanente ao conteúdo", included: true },
                { text: "250 exercícios de interpretação textual (artigos de opinião, textos jurídicos, editoriais de jornal, textos dissertativos, cartas, textos literários e científicos)", included: true },
