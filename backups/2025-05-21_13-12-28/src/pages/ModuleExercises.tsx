          ...
          <Card>
            <CardContent className="p-6">
              {moduleId ? (
                <ExerciseSession 
                  categoryId={moduleId}
                  maxExercises={moduleId === 'prova-dois-pontos' || moduleId === 'prova-parenteses' ? 30 : 10} 
                  moduleTitle={
                    moduleId === 'ponto-e-virgula' ? 'Ponto e Vírgula - Exercício 1' :
                    moduleId === 'ponto-e-virgula-2' ? 'Ponto e Vírgula - Exercício 2' :
                    moduleId === 'ponto-e-virgula-3' ? 'Ponto e Vírgula - Exercício 3' :
                    ...
                    moduleId === 'dois-pontos-5' ? 'Dois Pontos - Exercício 5' :
                    moduleId === 'prova-dois-pontos' ? 'Prova Final de Dois Pontos' :
                    moduleId === 'parenteses' ? 'Parênteses - Exercício 1' :
                    moduleId === 'parenteses-2' ? 'Parênteses - Exercício 2' :
                    moduleId === 'parenteses-3' ? 'Parênteses - Exercício 3' :
                    moduleId === 'parenteses-4' ? 'Parênteses - Exercício 4' :
                    moduleId === 'parenteses-5' ? 'Parênteses - Exercício 5' :
                    moduleId === 'prova-parenteses' ? 'Prova Final de Parênteses' :
                    moduleTitle
                  }
                />
              ) : (
